...
<CardGroup cols={2}>
  ...
  <Card title="Strength Progress" icon="chart-line-up">
    Resolve exercise variants and analyze weight, volume, repetitions, and estimated 1RM over time.
  </Card>
