...
SERIES_TYPE_TO_GROUP_EVENT: dict[str, str] = {
    ...
    # Nutrition
    "dietary_energy_consumed": WebhookEventType.NUTRITION_CREATED,
    "dietary_carbohydrates": WebhookEventType.NUTRITION_CREATED,
    "dietary_protein": WebhookEventType.NUTRITION_CREATED,
    "dietary_fat_total": WebhookEventType.NUTRITION_CREATED,
    "dietary_water": WebhookEventType.NUTRITION_CREATED,
    # Activity Distance
...
SERIES_TYPE_TO_GRANULAR_EVENT: dict[str, str] = {
    ...
    "dietary_energy_consumed": WebhookEventType.SERIES_DIETARY_ENERGY_CONSUMED,
    "dietary_carbohydrates": WebhookEventType.SERIES_DIETARY_CARBOHYDRATES,
    "dietary_protein": WebhookEventType.SERIES_DIETARY_PROTEIN,
    "dietary_fat_total": WebhookEventType.SERIES_DIETARY_FAT_TOTAL,
    "dietary_water": WebhookEventType.SERIES_DIETARY_WATER,
